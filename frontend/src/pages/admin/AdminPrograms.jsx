      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
          ...
          <div>
            ...
            {form.name && <p className="text-xs text-gray-400 mt-1">Slug: <span className="font-mono">{form.name.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/^-|-$/g, '')}</span></p>}
          </div>
          <div>
                  ...
                  <div key={p.id}>
                    <button className="w-full text-left px-6 py-5 hover:bg-gray-50 transition-colors"
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        <svg className={`w-5 h-5 text-gray-400 transition-transform ml-4 flex-shrink-0 ${expanded === p.id ? 'rotate-180' : ''}`}
